...
RSpec.describe "artist show page" do
  ...
  it "should display artist info" do
    ...
    expect(page).to have_content(@artist.year)
    expect(page).to have_content(@artist.location)
  end
  ...
  it "should display artist's paintings" do
    ...
    expect(page).to have_css(".painting", count: 5)
